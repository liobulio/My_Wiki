...
> 与现有持仓 [[ceg]] / [[tln]] / [[vst]]（[[ai-power-ipp-bull]]）同一逻辑。登记为机会页是为了跟踪**哪些机构在讲这个故事、什么时候不讲了**。

## Thesis Test (proposed)
...
## Logic
三家外资从不同角度给出同一结论：BlackRock 把"电力、电网、芯片、数据中心"列为 AI 基建主题中该拥有的瓶颈；
大摩把算力容量翻两番量化为 ~120 GW；高盛把公用事业列入 AI capex 的盈利受益者。瓶颈资产的共同点：建设周期长、审批受监管、
需求由 capex 指引决定——因此 capex 指引（[[2026-09-06-pacific-securities-overseas-ai|太平洋证券汇总的四家 ~$0.72–0.75T]]）是最重要的领先指标。
...
- 监管封顶：PJM 容量价格上限延长至 2029/30 已经是现实的利润天花板（[[2026-08-06-ceg-8k-q2-earnings]]）；
- AI ROI 证伪（[[2026-09-11-apollo-daily-spark-ai-roi]]）。

## Sources
[[2026-09-08-blackrock-bii-weekly-japan-us-bonds]] · [[2026-09-09-morgan-stanley-nowak-ai-spending-payoff]] · [[2026-05-28-goldman-sp500-8000]]
